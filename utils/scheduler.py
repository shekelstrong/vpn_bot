...
3. Ссылка подписки остаётся той же, но истёкший ключ пропадает при обновлении в Hiddify
4. Все уведомления упоминают Hiddify (не V2Box/Happ)
"""
...
NOTIFICATION_MESSAGES = {
    ...
    "tier_expired_standard": "🛡 <b>Срок стандартного VPN истёк</b>\n\n"
                             "Обновите подписку в Hiddify — истёкший ключ исчезнет автоматически.\n"
    ...
    "tier_expired_premium": "🚀 <b>Срок VIP (обход белых списков) истёк</b>\n\n"
                            "Обновите подписку в Hiddify — истёкший VIP-ключ исчезнет автоматически.\n"
