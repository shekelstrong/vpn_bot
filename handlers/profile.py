...
async def send_subscription_info(message: types.Message | types.CallbackQuery, subscription_url: str, vless_link: str = "", user=None):
    ...
    success_text = (
        ...
        f"1. Установите приложение для вашего устройства:\n"
        f"• <b>iOS / macOS:</b> <a href='https://apps.apple.com/us/app/v2box-v2ray-client/id6446814690'>V2Box (Рекомендуем)</a> или <a href='https://apps.apple.com/us/app/happ-proxy-utility/id6504287215'>Happ</a>\n"
        f"• <b>Android:</b> <a href='https://play.google.com/store/apps/details?id=com.happproxy'>Happ</a>\n"
        f"• <b>Windows:</b> <a href='https://github.com/Happ-proxy/happ-desktop/releases/latest/download/setup-Happ.x64.exe'>Happ</a>\n"
        f"2. Скопируйте ссылку на подписку (выше).\n"
        f"3. Откройте приложение, нажмите <b>«+»</b> и выберите <b>«Import from Clipboard»</b>.\n"
